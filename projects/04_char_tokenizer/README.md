...
projects/04_char_tokenizer/              演示、测试、报告和阶段文档
projects/04_char_tokenizer/model.py       只处理 token ID 的 Bigram 对照模型
...
```text
projects/04_char_tokenizer/artifacts/char_tokenizer.json
```
