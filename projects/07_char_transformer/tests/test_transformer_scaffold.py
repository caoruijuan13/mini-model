...
attention = import_module("projects.07_char_transformer.attention")
layers = import_module("projects.07_char_transformer.layers")
model_module = import_module("projects.07_char_transformer.model")
generation = import_module("projects.07_char_transformer.generate")
