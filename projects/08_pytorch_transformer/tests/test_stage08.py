...
data = import_module("projects.08_pytorch_transformer.data")
model_module = import_module("projects.08_pytorch_transformer.model")
train_module = import_module("projects.08_pytorch_transformer.train")
generation = import_module("projects.08_pytorch_transformer.generate")
stage07_data = import_module("projects.07_char_transformer.data")
CharTokenizer = import_module("projects.tokenization.char_tokenizer").CharTokenizer
...
def test_train_and_evaluate_keeps_numpy_training_boundary_and_writes_report(
    ...
    assert model_module.TorchCharTransformer.load(model_path).config == config
