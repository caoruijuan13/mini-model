...
```bash
python3 -m pytest -q projects/stage05_token_mlp/tests/test_data.py
python3 -m pytest -q projects/stage05_token_mlp/tests/test_forward.py
python3 -m pytest -q projects/stage05_token_mlp/tests/test_gradients.py
python3 -m pytest -q projects/stage05_token_mlp/tests/test_generation.py
```
