...
```bash
PYTHONPATH=projects/stage06_training_engineering python3 projects/stage06_training_engineering/train.py
```

使用完全相同的参数恢复 checkpoint：

```bash
PYTHONPATH=projects/stage06_training_engineering python3 projects/stage06_training_engineering/train.py --resume
```
