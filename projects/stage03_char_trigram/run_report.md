...
本报告只记录真实语料 trigram 结果。原始 bigram 的指标和 sample 保存在项目 02 的 [运行报告](../stage02_char_bigram/run_report.md)，没有被覆盖。
...
```text
projects/stage03_char_trigram/artifacts/char_trigram.npz
```
